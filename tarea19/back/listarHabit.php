                                        ...
                                        <tbody>
                                            ...
                                            while ($fila = $respuesta->fetch_assoc()) {
                                                echo '<tr>
                                                        ...
                                                        <td>' . $fila['espacio'] . '</td> 
                                                        <td>' . $fila['precio'] . '</td> 
                                                        <td><a href="javascript:eliminarHabit(' . $fila["id"] . ')"><i class="fas fa-trash-alt text-danger "></i></a></td>
                                                        <td><a href="javascript:editarHabit(' . $fila["id"] . ')"><i class="far fa-edit text-success"></i></a></td>
                                                    </tr>';
                                                }
                                            ?>
                                        </tbody>
                                            ...
                                            while ($fila2 = $respuesta2->fetch_assoc()) {
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td>' . $fila2['nrocamas'] . '
                                                        <td><a href="javascript:eliminarTipoHabit('.$fila2["id"].')"><i class="fas fa-trash-alt text-danger"></i></a></td>
                                                        <td><a href="javascript:editarTipoHabit('.$fila2["id"].')"><i class="far fa-edit text-success"></i></a></td>
                                                    </tr>';
                                            }
                                            ?>
                                        </tbody>
