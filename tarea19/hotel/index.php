        ...
        <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
          <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
            ...
            if (isset($_SESSION['correo'])) {
              ...
              echo '</p>
                <a class="dropdown-item" href="#">' . $_SESSION['nombre'] . '</a>
            ...
            <li class="nav-item cta">
              <a class="nav-link" id="navReservas" href="javascript:cargarHotel('reservas.html', '#navReservas')"><span>Reservas</span></a>
            </li>
          </ul>
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-12 text-center">
            ...
            <div class="mb-5 elemento-animado">
              ...
              <p><a href="reservas.html" class="btn btn-primary">Reservas</a></p>
            </div>
